...
c     # These are used even in the mapped case, but ixy is
c     # always set to 1;  rotation matrix rot does switches
c     # coordinates for us.
      if (ixy .eq. 1) then
         mu = 2
         mv = 3
      else
